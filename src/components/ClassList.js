...
class ClassList extends Component{
	...
	hideClassForm = () => {
		this.setState({showClassForm: false, className: "", section: "", subject: "", room: ""});
	}
	...
	render() {
		return(
          ...
          <Modal.Body>
          	<input type="text" placeholder="Class Name" name="className" onChange={this.formInputHandler} value={this.state.className}/>
          	<input type="text" placeholder="Section" name="section" onChange={this.formInputHandler} value={this.state.section}/>
          	<input type="text" placeholder="Subject" name="subject" onChange={this.formInputHandler} value={this.state.subject}/>
          	<input type="text" placeholder="Room" name="room" onChange={this.formInputHandler} value={this.state.room}/>
          </Modal.Body>
          <Modal.Footer>
            ...
            <Button variant="primary" onClick={this.createClassHandler}>
              Create Class
				...
				<nav className='class-list-navbar'>
					...
					<i className="fas fa-plus create-class-icon" onClick={this.showClassForm}></i>
				</nav>
				<div className='classes-container'>
					{this.props.classes.length ? this.props.classes.map((newClass, i) => {
						return(
							<div key={i} className='newClass' onClick={() => window.location.pathname=`/class/${newClass.id}`}>
